...
m = [1,3,6,9];
for i = 1:4
    paramaters = m(i)*[0 1; -1 1; -1 0; -1 -1]; % 0, 45, 90 and 135 degrees.
    subplot(2,2,i);
    ...
    title(append('Step length: ', num2str(m(i))));
    h.Colormap = flag;
end
...
m = [1,2,3,4];
for i = 1:4
    paramaters = m(i)*[1 3]; % about 18 degrees.
    subplot(2,2,i);
...
m = [2,3,4,5];
for i = 1:4
    paramaters = m(i)*[-1 1; 1 1]; % 45 and -45 degrees.
    subplot(2,2,i);
